        ...
        <div id="descriptionText" class="description-block show reg_box" style="display: block;">
            <section class="hero reg_box_buttons">
                <form action="/register" method="post" class="card_form_1">
                    ...
                    <div>
                        <p>Название компании : </p><input required name='company_name'>
                    </div>
                    <div>
                        <p>Адрес : </p><input required name='address'>
                    </div>
                    <div>
                        <p>Город : </p><input required name='city'>
                    </div>
                    <div>
                        <p>Почтовый индекс : </p><input required name='post_index'>
                    </div>
